...
public class QueryforReserveAbort {
    ...
    public static void main(String[] a) {
        ...
        try {
            ...
            check(0, r7);
            wc.commit(xid);
            System.out.println("QueryforReserveAbort Test pass.");

            Connector.cleanUpExit(0);
        } catch (Exception e) {
            System.out.println("QueryforReserveAbort Test fail:" + e.getMessage());
    ...
    private static void check(int expect, int real) {
        if (expect != real) {
            ...
            System.err.println("QueryforReserveAbort Test fail");
            Connector.cleanUpExit(1);
        }
    }
